...
python3.11 manage.py collectstatic --noinput --settings=get_things_done.settings.production

echo "Running migrations"
python3.11 manage.py migrate --settings=get_things_done.settings.production
